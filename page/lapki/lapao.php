<?php
    if(isset($_POST["cari"])){
        ...
        WHERE headeranggaran.jenis = 'AO' AND newdetailanggaran.status = '3'
                                    ...
                                    <table class="table table-striped table-bordered table-hover" id="datatabel">
                                        <thead>
                                            <tr>
                                                ...
                                                <th class="text-center" width="7%">Nama Kegiatan</th>
                                                ...
                                                <th class="text-center" width="10%">Jml. Biaya Jasa</th> 
                                                <th class="text-center" width="10%">Jml. Biaya Material</th>
                                                <th class="text-center" width="7%">Unit APP</th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php
