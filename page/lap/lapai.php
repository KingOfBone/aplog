<?php
    if(isset($_POST["cari"])){
        ...
        AND headeranggaran.jenis = 'AI' AND newdetailanggaran.status = '3' AND year(headeranggaran.tartglmulai) = $data_kontrol[tahun] 
        AND headeranggaran.tartglmulai between '$key' AND '$key2'") or die (mysql_error());
    }
?>
        ...
        <div id="page-inner">
            ...
            <form method="POST" action="" id="validate-cari">
                <div class="row">
                    ...
                    <div class="col-md-1"><p style="padding: 0;" class="">S / D </p></div>
                    <div class="col-md-2">
