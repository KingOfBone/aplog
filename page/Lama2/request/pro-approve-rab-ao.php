                                ...
                                -->
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" width="5%">Uraian Kegiatan</th>
                                            <th class="text-center" width="3%">No. Usulan</th>
                                            <th class="text-center" width="4%">No. WBS</th>
                                        <!--
                                        ...
                                        -->
                                            ...
                                            <th class="text-center" width="2%">Jml. Biaya Material</th>
                                    ...
                                    <?php	
                                        ...
                                        $sqlangg = mysql_query("SELECT 
                                            ...
                                            WHERE headeranggaran.kodeapp = '$_SESSION[kodeapp]' AND status IN ('5','6','7','8')
                                        ...
                                        <tr>
                                                ...
                                                -->
                                                    ...
                                                    $sqlstatus = mysql_fetch_array(mysql_query ("SELECT
                                                            ...
                                                            FROM newdetailanggaran 
                                                            INNER JOIN headeranggaran ON newdetailanggaran.randomid = headeranggaran.randomid
                                                            WHERE headeranggaran.kodeapp = '$_SESSION[kodeapp]' AND newdetailanggaran.status IN('5','6','7','8')
                                                    ...
                                                    <td class="text-center">
                                                        <?php   
                                                                ...
                                                                else if ($permintaan['status'] == '6') {echo "Reject RAB";}
                                                                else if ($permintaan['status'] == '7') {echo "Approve RAB";}
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <a title="delete" href="#" id="del-apprab-ao=<?php echo $rowC["kodedetail"]?>" class="delete"><i class="fa fa-trash-o fa-2x"></i></a>
                                                        -->
                                                    </td>
                            					</tr>
                            				<?php }  ?>
  ...
  <div class="modal-dialog ">
    <div class="modal-content wrap-dialog" style="border-radius: 0;">
      <!-- dialog body -->
       <div class="modal-header bg-primary">
            <button type="button" class="close" data-dismiss="modal">&times;</button>
            <h4 class="modal-title text-center">Approval RAB AO</h4>
       </div>
