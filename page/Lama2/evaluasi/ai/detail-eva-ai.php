...
WHERE status IN ('5','6','7','8') AND newdetailanggaran.kodedetail = '$detail'");
...
<div class="row">
    ...
    -->
          ...
          <div class="row">
            <div class="col-md-5"><label>No. Purchase Request (PR)</label></div>
            <div class="col-md-1"> : </div>
          ...
          <div class="row">
            <div class="col-md-5"><label>Perkiraan tgl mulai</label></div>
            <div class="col-md-1"> : </div>
        ...
        <table class="table table-striped table-bordered table-hover" id="datatabel">
            <thead>
                <tr>
                  ...
                  <th class="text-center" width="1%">Harga Satuan Jasa </th>
                  <th class="text-center" width="1%">Harga Satuan Meterial </th>
        ...
        <?php
                            				...
                            				?>
                            					<tr>
                                                    ...
                                                    -->
                                                    <td>
                                                    <?php if ($row['status'] == '5') {echo "Usulan RAB";}
                                                    else if ($row['status'] == '6') {echo "Reject RAB";}
                                                    else if ($row['status'] == '7') {echo "Approve RAB";}
