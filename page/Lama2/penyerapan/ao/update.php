...
$sqlA= mysql_query("SELECT * FROM pembayaran WHERE kodepym = '$idA' ORDER BY randomid = '$idA'") or die (mysql_error());
if(mysql_num_rows($sqlA)==0);
$rowA = mysql_fetch_array($sqlA);

$sqlB= mysql_query("SELECT *,(SELECT uraiankegiatan from headeranggaran b where a.randomid=b.randomid) as uraiankegiatan FROM realisasi a where kodepym = '$idA'");
$rowB = mysql_fetch_array($sqlB);

$sqlC= mysql_query("SELECT * FROM pembayaran where randomid = '$idA'");
            ...
            <div class="panel-body">
                            <div class="row">
                                ...
                                <input type="hidden" name="koderealisasi" value="<?php echo $idA; ?>" />
                                    <div class="col-lg-6">
                                        <?php $query1 = mysql_fetch_array(mysql_query("SELECT SUM(jmlpym) as totalpenyerapan FROM `pembayaran` WHERE randomid = '$sqlC'"));?>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    <input class="form-control" name="jmlpym" type="text" onKeyPress="return isNumberKey(event)" required="jmlpym" data-rule-required="true" value="<?php echo $rowA["jmlpym"]; ?>" data-msg-required="Mohon masukkan jumlah pembayaran." placeholder="masukkan jumlah pembayaran" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    <input class="form-control" name="tahap" type="text" onKeyPress="return isNumberKey(event)" required="tahap" data-rule-required="true" value="<?php echo $rowA["tahap"]; ?>" data-msg-required="Mohon masukkan tahap." placeholder="masukkan tahap" />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    <input  type="text" onKeyPress="return isNumberKeyTgl(event)" class="form-control" required="tglinput" id="datepicker2" name="tglinput" value="<?php if($rowA["tglinput"]=="0000-00-00"){}else{ echo format_tgl($rowA["tglinput"]); } ?>" data-rule-required="true" data-rule-date="true" data-msg-date="format yang benar dd/mm/yyyy" data-msg-required="mohon masukkan data tanggal pembayaran." />
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                                    <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="col-md-8">
                                                                    <input type="text" class="form-control" disabled="" id="totalkontrak" value="<?php echo ($rowB["nilaikontrak"])-($query1["totalpenyerapan"]); ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="row">
                                                            <div class="col-md-6">
                                                                <div class="col-md-8">
                                                                    <input type="text" hidden="" class="form-control" disabled="" id="totalserapan" value="<?php echo $query1["totalpenyerapan"] ?>" />
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
