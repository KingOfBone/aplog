                              ...
                              <div class="form-group">
                                    <div class="row">
                                        <div class="col-md-10">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text"   name='mitigasi' class="form-control"  disabled="" value="<?php echo $rowA["mitigasi"]; ?>" data-msg-required="Mohon masukkan mitigasi " placeholder="masukkan mitigasi " />
                                                    </div>
                                        </div>
                                    </div>
                              </div> 
