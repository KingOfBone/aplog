...
$sql = mysql_query("SELECT
    ...
    AND headeranggaran.jenis = 'AI' AND newdetailanggaran.status = '4'
                      				...
                      				?>
                            					...
                            					<tr>
                                                    ...
                                                    $sqlstatus = mysql_fetch_array(mysql_query ("SELECT
                                                            ...
                                                            FROM newdetailanggaran 
                                                            INNER JOIN headeranggaran ON newdetailanggaran.randomid = headeranggaran.randomid
                                                            WHERE headeranggaran.kodebidang = '$_SESSION[kodebidang]' AND newdetailanggaran.status IN('4','5','6','7')
                                                            AND newdetailanggaran.randomid = '".$row['randomid']."' AND headeranggaran.jenis = 'AI'
                                                    ...
                                                    <td class="text-center">
                                                        ...
                                                        <?php
                                                            ...
                                                            FROM newdetailanggaran 
                                                            INNER JOIN headeranggaran ON newdetailanggaran.randomid = headeranggaran.randomid
                                                            WHERE headeranggaran.kodebidang = '$_SESSION[kodebidang]' AND newdetailanggaran.status = '5'
                                                            AND newdetailanggaran.randomid = '".$row['randomid']."' AND headeranggaran.jenis = 'AI'")); {
                                                        ?>
                                                         <a title="update" href="index.php?update-rab-ai=<?php echo $sql3["randomid"]?>&status=5" type="button"><i class="fa fa-pencil-square-o fa-2x"></i></a>
                                                         <?php }} ?>
                                                         <?php 
