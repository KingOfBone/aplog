<?php
    ...
    if(isset($_POST["submit"]))
    {
        ...
        status, kodebidang) VALUES (null,'$j','$i','$a','$b','$c','$e','9','$_SESSION[kodebidang]')");
...
WHERE status = '7' AND newdetailanggaran.randomid = '$idA'") or die (mysql_error());
                                                ...
                                                <div class="form-group">
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                                    ...
                                                                    <div class="col-md-8">
                                                                        <input  type="text" onKeyPress="return isNumberKeyTgl(event)" required="tglkontrak" class="form-control" id="datepicker" name="tglkontrak" placeholder="masukkan tanggal kontrak" />
                                                                    </div>
                                                        </div>
                                                    </div>
                                                </div>
