                                    ...
                                    <div class="col-lg-6">
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    <input class="form-control" name="namavendor" type="text" required="namavendor" data-rule-required="true" value="<?php echo $rowA["namavendor"]; ?>" data-msg-required="Mohon masukkan nama vendor." placeholder="masukkan nama vendor" />
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group">
