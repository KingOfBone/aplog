...
WHERE status = '7' AND newdetailanggaran.kodedetail = '$detail'");
...
FROM newdetailanggaran
INNER JOIN headeranggaran ON newdetailanggaran.randomid = headeranggaran.randomid
WHERE status = '7' AND newdetailanggaran.randomid = '$rowDetail[randomid]'");
?>
<div class="row">
        ...
        <?php
                            				...
                            				?>
                            					<tr>
                                                    ...
                                                    -->
                                                    <td>
                                                    <?php if ($row['status'] == '7') {echo "Approve (RAB)";}
