...
<div id="wrapper">
       ...
       <div id="page-wrapper" >
           ...
           <div class="row">
                ...
                <div class="col-md-2">
                    <a href="index.php?form-penyerapan-ai=<?php echo $idA;?>" type="submit" class="btn btn-sm btn-info"><i class="glyphicon glyphicon-plus"></i>Tambah Penyerapan</a>
                    <br /><br />
                </div>
                <?php } ?>
           <div class="col-lg-6">
                            				...
                            				?>
                            					<tr>
                                                    ...
                                                    <!--<a title="edit" href="index.php?update-penyerapan-ao=<?php echo $rowA["kodepym"]?>&<?php echo $rowA["randomid"]?>" type="button"><i class="fa fa-pencil-square-o fa-2x"></i></a>-->
                                                         ...
                                                         <a title="delete" href="#" id="delete-penyerapan-ai=<?php echo $rowC["kodepym"]?>" class="delete">
