...
?>
    ...
    <li>
        ...
        -->
        <li>
            <a href="index.php?monitor-evaluasi-ai"><i class="fa fa-briefcase fa-2x" aria-hidden="true"></i> Evaluasi Anggaran<span class=""></span></a>
        </li>
        <li>
            <a href="#"><i class="fa fa-certificate fa-2x" aria-hidden="true"></i> Evaluasi RAB<span class=""></span></a>
                <ul >
                    ...
                    <li>
                        <a href="index.php?monitor-eva-rabao"><i class="fa fa-folder fa-2x"></i> Rutin (AO)</a>
                    </li>
                    <li>
                        <a href="index.php?monitor-eva-rabai"><i class="fa fa-folder fa-2x"></i> Non Rutin (AI)</a>
                    </li>
                </ul>
        </li>
        <li>
