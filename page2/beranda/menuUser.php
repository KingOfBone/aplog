...
<ul>
        ...
        <li>
            <a href="index.php?data-penetapan-ai"><i class="fa fa-suitcase fa-2x"></i> Penetapan Anggaran<span class=""></span></a>
        </li>
        <li>
        ...
        <li>
            ...
            <ul>
                    ...
                    <li>
                        <a href="index.php?realisasi-ao"><i class="fa fa-map-o fa-2x"></i> Rutin (AO)</a>
                    </li>
                    <li>
                        <a href="index.php?realisasi"><i class="fa fa-map-o fa-2x"></i> Non Rutin (AI)</a>
                    </li>
            </ul>
        </li>
        <li>
            ...
            <ul>
                    ...
                    <li>
                        <a href="index.php?penyerapan-ao"><i class="fa fa-map-o fa-2x"></i>  Rutin (AO)</a>
                    </li>
                    <li>
                        <a href="index.php?penyerapan"><i class="fa fa-map-o fa-2x"></i> Non Rutin (AI)</a>
                    </li>
            </ul>
        </li>
        ...
        <li>
            <a href="#"><i class="fa fa-file-text fa-2x" aria-hidden="true"></i> Laporan<span class=""></span></a>
                <ul >
                    <li><a href="#" class="back">Main Menu</a></li>
                        <li class="nav-label"> Laporan Usulan Anggaran</li>
                        <li>
                            <li>
                        ...
                        <li class="nav-label"> Laporan Realisasi Anggaran</li>
                        <li>
                            <li>
                        ...
                        <li class="nav-label"> Laporan Penyerapan Anggaran</li>
                        <li>
                            <li>
